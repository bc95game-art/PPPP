...
/* renamed from: com.maxmind.db.Decoder */
...
public final class Decoder {
    ...
    /* renamed from: com.maxmind.db.Decoder$1 */
    /* loaded from: classes.dex */
    public static /* synthetic */ class C02781 {
    ...
    private <T> Object decodeByType(Type type, int i, Class<T> cls, Type type2) {
        Class<Object> cls2;
        switch (C02781.$SwitchMap$com$maxmind$db$Type[type.ordinal()]) {
            case 1:
    ...
    private static <T> String getParameterName(Class<T> cls, int i, Annotation[] annotationArr) {
        ...
        StringBuilder m = ViewModelProvider.Factory.CC.m598m("Constructor parameter ", i, " on class ");
    ...
    private int nextValueOffset(int i, int i2) {
        ...
        int i3 = C02781.$SwitchMap$com$maxmind$db$Type[ctrlData.getType().ordinal()];
        if (i3 == 1) {
            i2 += size * 2;
        } else if (i3 == 2) {
            i2 += size;
    ...
    public Decoder(NodeCache nodeCache, ByteBuffer byteBuffer, long j, ConcurrentHashMap<Class, CachedConstructor> concurrentHashMap) {
        ...
        this.cacheLoader = new NodeCache.Loader() { // from class: com.maxmind.db.Decoder$$ExternalSyntheticLambda0
            @Override // com.maxmind.p003db.NodeCache.Loader
