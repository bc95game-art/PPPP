...
public abstract class MaterialBackAnimationHelper {
    ...
    public MaterialBackAnimationHelper(View view) {
        ...
        this.hideDurationMax = LazyKt__LazyJVMKt.resolveThemeDuration(context, R.attr.motionDurationMedium2, 300);
        this.hideDurationMin = LazyKt__LazyJVMKt.resolveThemeDuration(context, R.attr.motionDurationShort3, 150);
        this.cancelDuration = LazyKt__LazyJVMKt.resolveThemeDuration(context, R.attr.motionDurationShort2, 100);
    }
}
