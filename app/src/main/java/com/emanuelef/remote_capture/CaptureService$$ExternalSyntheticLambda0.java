...
public final /* synthetic */ class CaptureService$$ExternalSyntheticLambda0 implements Runnable {
    public final /* synthetic */ int $r8$classId;
    public final /* synthetic */ Object f$0;

    public /* synthetic */ CaptureService$$ExternalSyntheticLambda0(int i, Object obj) {
        this.$r8$classId = i;
        this.f$0 = obj;
    }
    ...
    public final void run() {
        switch (this.$r8$classId) {
            ...
            case 2:
                ...
                return;
            case 3:
                ((CaptureService) this.f$0).reloadBlocklist();
                return;
            case 4:
