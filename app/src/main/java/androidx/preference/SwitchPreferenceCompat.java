...
public class SwitchPreferenceCompat extends TwoStatePreference {
    ...
    public SwitchPreferenceCompat(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, C0130R.attr.switchPreferenceCompatStyle);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.SwitchPreferenceCompat, C0130R.attr.switchPreferenceCompatStyle, 0);
    ...
    public final void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        syncSwitchView$1(preferenceViewHolder.findViewById(C0130R.C0132id.switchWidget));
    ...
    public final void performClick(View view) {
        ...
        if (((AccessibilityManager) this.mContext.getSystemService("accessibility")).isEnabled()) {
            syncSwitchView$1(view.findViewById(C0130R.C0132id.switchWidget));
