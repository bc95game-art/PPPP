...
public class DropDownPreference extends ListPreference {
    ...
    public final C00861 mItemSelectedListener = new AdapterView.OnItemSelectedListener() { // from class: androidx.preference.DropDownPreference.1
    ...
    public DropDownPreference(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, C0130R.attr.dropdownPreferenceStyle);
    ...
    public final void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        int i;
        Spinner spinner = (Spinner) preferenceViewHolder.itemView.findViewById(C0130R.C0132id.spinner);
