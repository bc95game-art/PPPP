...
public final class AlertController {
    ...
    public final PreferenceFragmentCompat.HandlerC00901 mHandler;
    ...
    public final Toolbar.View$OnClickListenerC00394 mButtonHandler = new Toolbar.View$OnClickListenerC00394(2, this);
    ...
    public final class AlertParams {
        ...
        public MultiSelectListPreferenceDialogFragmentCompat.DialogInterface$OnMultiChoiceClickListenerC00881 mOnCheckboxClickListener;
    ...
    public AlertController(Context context, AlertDialog alertDialog, Window window) {
        ...
        this.mWindow = window;
        PreferenceFragmentCompat.HandlerC00901 r6 = new PreferenceFragmentCompat.HandlerC00901();
        r6.this$0 = new WeakReference(alertDialog);
        this.mHandler = r6;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, R$styleable.AlertDialog, C0130R.attr.alertDialogStyle, 0);
