...
public abstract class CardView extends FrameLayout {
    ...
    public CardView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, C0130R.attr.materialCardViewStyle);
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.CardView, C0130R.attr.materialCardViewStyle, C0130R.style.CardView);
        if (obtainStyledAttributes.hasValue(2)) {
            ...
            if (fArr[2] > 0.5f) {
                i = getResources().getColor(C0130R.color.cardview_light_background);
            } else {
                i = getResources().getColor(C0130R.color.cardview_dark_background);
            }
