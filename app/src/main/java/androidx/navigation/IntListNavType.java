...
public final class IntListNavType extends NavType {
    ...
    public final Object get(Bundle bundle, String str) {
        ...
        switch (this.$r8$classId) {
            case 0:
                ...
                if (!bundle.containsKey(str) || Navigation.m652isNullimpl(bundle, str)) {
                    return null;
                }
    ...
    public final Object mo649parseValue(String value) {
        switch (this.$r8$classId) {
            case 0:
                ...
                return LazyKt__LazyJVMKt.listOf(NavType.IntType.mo649parseValue(value));
            case 1:
                return m648parseValue(value);
            case 2:
                Intrinsics.checkNotNullParameter(value, "value");
                return LazyKt__LazyJVMKt.listOf(NavType.BoolType.mo649parseValue(value));
            case 3:
                return parseValue(value);
            case 4:
                Intrinsics.checkNotNullParameter(value, "value");
                return LazyKt__LazyJVMKt.listOf(NavType.FloatType.mo649parseValue(value));
            case 5:
                return m646parseValue(value);
            case 6:
                return m647parseValue(value);
            case 7:
                Intrinsics.checkNotNullParameter(value, "value");
                return LazyKt__LazyJVMKt.listOf(NavType.LongType.mo649parseValue(value));
            case 8:
                Intrinsics.checkNotNullParameter(value, "value");
        ...
        switch (this.$r8$classId) {
            ...
            case 1:
                ...
                if (zArr != null) {
                    ...
                    Navigation.m653putNullimpl(bundle, key);
                    return;
                }
            case 2:
    ...
    /* renamed from: parseValue  reason: collision with other method in class */
    public static int[] m646parseValue(String value) {
        Intrinsics.checkNotNullParameter(value, "value");
        return new int[]{((Number) NavType.IntType.mo649parseValue(value)).intValue()};
    }

    /* renamed from: parseValue  reason: collision with other method in class */
    public static long[] m647parseValue(String value) {
        Intrinsics.checkNotNullParameter(value, "value");
        return new long[]{((Number) NavType.LongType.mo649parseValue(value)).longValue()};
    }

    public static float[] parseValue(String value) {
        Intrinsics.checkNotNullParameter(value, "value");
        return new float[]{((Number) NavType.FloatType.mo649parseValue(value)).floatValue()};
    }

    /* renamed from: parseValue  reason: collision with other method in class */
    public static boolean[] m648parseValue(String value) {
        Intrinsics.checkNotNullParameter(value, "value");
        return new boolean[]{((Boolean) NavType.BoolType.mo649parseValue(value)).booleanValue()};
    }
    ...
    public final Object parseValue(Object obj, String str) {
        switch (this.$r8$classId) {
            case 0:
                ...
                if (list != null) {
                    return CollectionsKt.plus(list, LazyKt__LazyJVMKt.listOf(intNavType.mo649parseValue(str)));
                }
                return LazyKt__LazyJVMKt.listOf(intNavType.mo649parseValue(str));
            case 1:
                boolean[] zArr = (boolean[]) obj;
                if (zArr == null) {
                    return m648parseValue(str);
                }
                boolean[] parseValue = m648parseValue(str);
            ...
            case 2:
                ...
                if (list2 != null) {
                    return CollectionsKt.plus(list2, LazyKt__LazyJVMKt.listOf(intNavType2.mo649parseValue(str)));
                }
                return LazyKt__LazyJVMKt.listOf(intNavType2.mo649parseValue(str));
            case 3:
                float[] fArr = (float[]) obj;
                if (fArr == null) {
            ...
            case 4:
                ...
                if (list3 != null) {
                    return CollectionsKt.plus(list3, LazyKt__LazyJVMKt.listOf(intNavType3.mo649parseValue(str)));
                }
                return LazyKt__LazyJVMKt.listOf(intNavType3.mo649parseValue(str));
            case 5:
                int[] iArr = (int[]) obj;
                if (iArr == null) {
                    return m646parseValue(str);
                }
                int[] parseValue3 = m646parseValue(str);
            ...
            case 6:
                long[] jArr = (long[]) obj;
                if (jArr == null) {
                    return m647parseValue(str);
                }
                long[] parseValue4 = m647parseValue(str);
            ...
            case 7:
                ...
                if (list4 != null) {
                    return CollectionsKt.plus(list4, LazyKt__LazyJVMKt.listOf(intNavType4.mo649parseValue(str)));
                }
                return LazyKt__LazyJVMKt.listOf(intNavType4.mo649parseValue(str));
            case 8:
                String[] strArr = (String[]) obj;
                if (strArr == null) {
