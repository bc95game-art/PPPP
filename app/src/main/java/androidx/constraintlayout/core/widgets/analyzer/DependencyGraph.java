    ...
    public final void basicMeasureWidgets(ConstraintWidgetContainer constraintWidgetContainer) {
        ...
        while (i8 < size) {
            ...
            if (constraintWidget.mVisibility == 8) {
                ...
                if (i9 == i && constraintWidget.mMatchConstraintDefaultWidth == 1 && (constraintAnchor4.mTarget == null || constraintAnchor3.mTarget == null)) {
                    i9 = 2;
                }
                if (i10 == 3 && constraintWidget.mMatchConstraintDefaultHeight == 1 && (constraintAnchor2.mTarget == null || constraintAnchor.mTarget == null)) {
                    i10 = 2;
                }
                HorizontalWidgetRun horizontalWidgetRun = constraintWidget.mHorizontalRun;
                horizontalWidgetRun.mDimensionBehavior = i9;
                ...
                verticalWidgetRun.mDimensionBehavior = i10;
                ...
                if (i13 == 4) {
                    ...
                    i6 = i14;
                    i5 = width;
                    i3 = (constraintWidgetContainer.getHeight() - constraintAnchor2.mMargin) - constraintAnchor.mMargin;
                } else {
                    i4 = i13;
                    i6 = i14;
                    i5 = width;
                ...
                dependencyGraph.measure(i6, i5, i4, i3, constraintWidget);
