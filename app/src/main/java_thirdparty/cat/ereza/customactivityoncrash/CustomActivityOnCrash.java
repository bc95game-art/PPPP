...
public abstract class CustomActivityOnCrash {
    ...
    /* renamed from: cat.ereza.customactivityoncrash.CustomActivityOnCrash$1  reason: invalid class name */
    /* loaded from: classes.dex */
    ...
    public static String getAllErrorDetailsFromIntent(Context context, Intent intent) {
        ...
        String m = ViewModelProvider.Factory.CC.m("Build version: ", str2, " \n");
        if (str != null) {
            m = m + "Build date: " + str + " \n";
        }
        ...
        String m2 = ViewModelProvider.Factory.CC.m(ViewModelProvider.Factory.CC.m(sb, str3, " \n") + "OS version: Android " + Build.VERSION.RELEASE + " (SDK " + Build.VERSION.SDK_INT + ") \n \n", "Stack trace:  \n");
        ...
        if (stringExtra != null) {
            sb3 = ViewModelProvider.Factory.CC.m(ViewModelProvider.Factory.CC.m(sb3, "\nUser actions: \n"), stringExtra);
        }
        String stringExtra2 = intent.getStringExtra("cat.ereza.customactivityoncrash.EXTRA_CUSTOM_CRASH_DATA");
        if (stringExtra2 != null) {
            return ViewModelProvider.Factory.CC.m(ViewModelProvider.Factory.CC.m(sb3, "\nAdditional data: \n"), stringExtra2);
        }
        return sb3;
    }
