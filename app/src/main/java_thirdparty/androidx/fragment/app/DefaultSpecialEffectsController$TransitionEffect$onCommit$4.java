    ...
    public final Object invoke() {
        switch (this.$r8$classId) {
            ...
            default:
                ...
                fragmentTransitionImpl.animateToStart(obj3, new DefaultSpecialEffectsController$TransitionEffect$$ExternalSyntheticLambda4(transitionEffect, this.$container));
                return Unit.INSTANCE;
        }
    }
