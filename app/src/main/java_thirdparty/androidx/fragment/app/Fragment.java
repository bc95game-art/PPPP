...
public abstract class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner {
    ...
    Runnable mPostponedDurationRunnable = new AnonymousClass1(this, 0);
    ...
    public void callStartTransitionListener(boolean z) {
        ...
        if (this.mView != null && (viewGroup = this.mContainer) != null && (fragmentManager = this.mFragmentManager) != null) {
            ...
            if (z) {
                this.mHost.handler.post(new AnonymousClass4(0, orCreateController));
            } else {
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        this.mChildFragmentManager.dump(ViewModelProvider.Factory.CC.m(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public final FragmentManager getChildFragmentManager() {
        ...
        throw new IllegalStateException(ViewModelProvider.Factory.CC.m("Fragment ", this, " has not been attached yet."));
    }
    ...
    public final FragmentManager getParentFragmentManager() {
        ...
        throw new IllegalStateException(ViewModelProvider.Factory.CC.m("Fragment ", this, " not associated with a fragment manager."));
    }
    ...
    public LifecycleOwner getViewLifecycleOwner() {
        ...
        throw new IllegalStateException(ViewModelProvider.Factory.CC.m("Can't access the Fragment View's LifecycleOwner for ", this, " when getView() is null i.e., before onCreateView() or after onDestroyView()"));
    }
    ...
    public void performActivityCreated(Bundle bundle) {
        ...
        throw new AndroidRuntimeException(ViewModelProvider.Factory.CC.m("Fragment ", this, " did not call through to super.onActivityCreated()"));
    }
    ...
    public void performAttach() {
        ...
        throw new AndroidRuntimeException(ViewModelProvider.Factory.CC.m("Fragment ", this, " did not call through to super.onAttach()"));
    }
    ...
    public void performCreate(Bundle bundle) {
        ...
        throw new AndroidRuntimeException(ViewModelProvider.Factory.CC.m("Fragment ", this, " did not call through to super.onCreate()"));
    }
    ...
    public void performCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (onCreateView != null) {
            ...
            view2.setTag(R.id.view_tree_view_model_store_owner, fragmentViewLifecycleOwner2);
            View view3 = this.mView;
            FragmentViewLifecycleOwner fragmentViewLifecycleOwner3 = this.mViewLifecycleOwner;
            Intrinsics.checkNotNullParameter(view3, "<this>");
            view3.setTag(R.id.view_tree_saved_state_registry_owner, fragmentViewLifecycleOwner3);
    ...
    public void performDestroy() {
        ...
        onDestroy();
        if (!this.mCalled) {
            throw new AndroidRuntimeException(ViewModelProvider.Factory.CC.m("Fragment ", this, " did not call through to super.onDestroy()"));
        }
    }
    ...
    public void performDestroyView() {
        ...
        throw new AndroidRuntimeException(ViewModelProvider.Factory.CC.m("Fragment ", this, " did not call through to super.onDestroyView()"));
    }
    ...
    public void performDetach() {
        ...
        throw new AndroidRuntimeException(ViewModelProvider.Factory.CC.m("Fragment ", this, " did not call through to super.onDetach()"));
    }
    ...
    public void performPause() {
        ...
        onPause();
        if (!this.mCalled) {
            throw new AndroidRuntimeException(ViewModelProvider.Factory.CC.m("Fragment ", this, " did not call through to super.onPause()"));
        }
    }
    ...
    public void performResume() {
        ...
        throw new AndroidRuntimeException(ViewModelProvider.Factory.CC.m("Fragment ", this, " did not call through to super.onResume()"));
    }
    ...
    public void performStart() {
        ...
        throw new AndroidRuntimeException(ViewModelProvider.Factory.CC.m("Fragment ", this, " did not call through to super.onStart()"));
    }
    ...
    public void performStop() {
        ...
        onStop();
        if (!this.mCalled) {
            throw new AndroidRuntimeException(ViewModelProvider.Factory.CC.m("Fragment ", this, " did not call through to super.onStop()"));
        }
    }
    ...
    public final AnonymousClass10 prepareCallInternal(final ActivityResultContract activityResultContract, final AnonymousClass7 r10, final ActivityResultCallback activityResultCallback) {
        if (this.mState <= 1) {
        ...
        throw new IllegalStateException(ViewModelProvider.Factory.CC.m("Fragment ", this, " is attempting to registerForActivityResult after being created. Fragments must call registerForActivityResult() before they are created (i.e. initialization, onAttach(), or onCreate())."));
    }
    ...
    public final <I, O> ActivityResultLauncher registerForActivityResult(ActivityResultContract activityResultContract, ActivityResultCallback activityResultCallback) {
        return prepareCallInternal(activityResultContract, new AnonymousClass7(0, this), activityResultCallback);
    }
    ...
    public final void requestPermissions(String[] permissions, int i) {
        ...
        throw new IllegalStateException(ViewModelProvider.Factory.CC.m("Fragment ", this, " not attached to Activity"));
    }
    ...
    public final FragmentActivity requireActivity() {
        ...
        throw new IllegalStateException(ViewModelProvider.Factory.CC.m("Fragment ", this, " not attached to an activity."));
    }
    ...
    public final Bundle requireArguments() {
        ...
        throw new IllegalStateException(ViewModelProvider.Factory.CC.m("Fragment ", this, " does not have any arguments."));
    }
    ...
    public final Context requireContext() {
        ...
        throw new IllegalStateException(ViewModelProvider.Factory.CC.m("Fragment ", this, " not attached to a context."));
    }
    ...
    public final Object requireHost() {
        ...
        throw new IllegalStateException(ViewModelProvider.Factory.CC.m("Fragment ", this, " not attached to a host."));
    }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (getContext() == null) {
            throw new IllegalStateException(ViewModelProvider.Factory.CC.m("Fragment ", this, " is not attached to any Fragment or host"));
        }
    ...
    public final View requireView() {
        ...
        throw new IllegalStateException(ViewModelProvider.Factory.CC.m("Fragment ", this, " did not return a View from onCreateView() or this was called before onCreateView()."));
    }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new AndroidRuntimeException(ViewModelProvider.Factory.CC.m("Fragment ", this, " did not call through to super.onViewStateRestored()"));
    ...
    public void setTargetFragment(Fragment fragment, int i) {
        ...
        throw new IllegalArgumentException(ViewModelProvider.Factory.CC.m("Fragment ", fragment, " must share the same FragmentManager to be set as a target fragment"));
    }
    ...
    public static Fragment instantiate(Context context, String str, Bundle bundle) {
        try {
            ...
            throw new RuntimeException(ViewModelProvider.Factory.CC.m("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e);
        } catch (InstantiationException e2) {
            throw new RuntimeException(ViewModelProvider.Factory.CC.m("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e2);
        } catch (NoSuchMethodException e3) {
            throw new RuntimeException(ViewModelProvider.Factory.CC.m("Unable to instantiate fragment ", str, ": could not find Fragment constructor"), e3);
        } catch (InvocationTargetException e4) {
            throw new RuntimeException(ViewModelProvider.Factory.CC.m("Unable to instantiate fragment ", str, ": calling Fragment constructor caused an exception"), e4);
        }
    }
    ...
    public final <I, O> ActivityResultLauncher registerForActivityResult(ActivityResultContract activityResultContract, ActivityResultRegistry activityResultRegistry, ActivityResultCallback activityResultCallback) {
        return prepareCallInternal(activityResultContract, new AnonymousClass7(1, activityResultRegistry), activityResultCallback);
    }
