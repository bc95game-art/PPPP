...
public final class DefaultSpecialEffectsController {
    ...
    public final class TransitionEffect extends SpecialEffectsController$Effect {
        ...
        */
        public final kotlin.Pair createMergedTransition(android.view.ViewGroup r34, androidx.fragment.app.SpecialEffectsController$FragmentStateManagerOperation r35, androidx.fragment.app.SpecialEffectsController$FragmentStateManagerOperation r36) {
            /*
        ...
        public final void onCommit(ViewGroup container) {
            ...
            while (i < size3) {
                ...
                fragmentTransitionImpl.setListenerForTransitionEnd(specialEffectsController$FragmentStateManagerOperation4.fragment, obj3, this.transitionSignal, new DefaultSpecialEffectsController$TransitionEffect$$ExternalSyntheticLambda1(specialEffectsController$FragmentStateManagerOperation4, this, 1));
            }
        ...
        public final void onStart(ViewGroup container) {
            ...
            if (isSeekingSupported() && getTransitioning()) {
                ...
                while (i < size3) {
                    ...
                    this.transitionImpl.setListenerForTransitionEnd(obj4, this.transitionSignal, fragment$$ExternalSyntheticLambda1, new DefaultSpecialEffectsController$TransitionEffect$$ExternalSyntheticLambda1(specialEffectsController$FragmentStateManagerOperation4, this, 0));
                }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void collectEffects(java.util.ArrayList r26, boolean r27) {
        /*
