                ...
                if (f == ((Fragment) matcherMatchResult.matcher)) {
                    ...
                    synchronized (((CopyOnWriteArrayList) fragmentAnim$AnimationOrAnimator.animator)) {
                        ...
                        while (true) {
                            if (i >= size) {
                                break;
                            } else if (((FragmentLifecycleCallbacksDispatcher$FragmentLifecycleCallbacksHolder) ((CopyOnWriteArrayList) fragmentAnim$AnimationOrAnimator.animator).get(i)).callback == matcherMatchResult) {
