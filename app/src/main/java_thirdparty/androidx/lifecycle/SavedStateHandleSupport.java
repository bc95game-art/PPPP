...
public abstract class SavedStateHandleSupport {
    ...
    public static final Transition.AnonymousClass1 DEFAULT_ARGS_KEY = new Transition.AnonymousClass1(9);
    ...
    public static final SavedStateHandlesVM getSavedStateHandlesVM(ViewModelStoreOwner viewModelStoreOwner) {
        ...
        Transition.AnonymousClass1 factory = new Transition.AnonymousClass1(8);
