    ...
    public final ViewModel create(Class cls, String str) {
        ...
        if (lifecycle != null) {
            ...
            if (constructor != null) {
                ...
                if (Transition.AnonymousClass1._instance == null) {
                    Transition.AnonymousClass1._instance = new Transition.AnonymousClass1(10);
                }
                Intrinsics.checkNotNull(Transition.AnonymousClass1._instance);
