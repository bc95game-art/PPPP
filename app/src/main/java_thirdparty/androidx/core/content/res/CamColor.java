...
public final class CamColor {
    ...
    public static CamColor fromColor(int i) {
        ...
        float f10 = viewingConditions.mC;
        ...
        float pow5 = ((float) Math.pow((f20 * viewingConditions.mNbb) / f11, viewingConditions.mZ * f10)) * 100.0f;
        ...
        float pow6 = ((float) Math.pow(1.64d - Math.pow(0.29d, viewingConditions.mN), 0.73d)) * ((float) Math.pow((((((((float) (Math.cos(((f * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f) * 3846.1538f) * viewingConditions.mNc) * viewingConditions.mNcb) * ((float) Math.sqrt((f17 * f17) + (f16 * f16)))) / (f19 + 0.305f), 0.9d)) * ((float) Math.sqrt(pow5 / 100.0d));
