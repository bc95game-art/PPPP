...
public class SeekBarPreference extends Preference {
    ...
    public final AnonymousClass1 mSeekBarChangeListener = new SeekBar.OnSeekBarChangeListener() { // from class: androidx.preference.SeekBarPreference.1
    ...
    public final AnonymousClass2 mSeekBarKeyListener = new View.OnKeyListener() { // from class: androidx.preference.SeekBarPreference.2
