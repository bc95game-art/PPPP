...
public class ListPreference extends DialogPreference {
    ...
    public ListPreference(Context context, AttributeSet attributeSet, int i) {
        ...
        if (obtainStyledAttributes.getBoolean(4, obtainStyledAttributes.getBoolean(4, false))) {
            if (Transition.AnonymousClass1.sSimpleSummaryProvider == null) {
                Transition.AnonymousClass1.sSimpleSummaryProvider = new Transition.AnonymousClass1(12);
            }
            this.mSummaryProvider = Transition.AnonymousClass1.sSimpleSummaryProvider;
            notifyChanged();
        }
