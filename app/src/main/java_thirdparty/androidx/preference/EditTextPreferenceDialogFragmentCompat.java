...
public class EditTextPreferenceDialogFragmentCompat extends PreferenceDialogFragmentCompat {
    ...
    public final PreferenceGroup.AnonymousClass1 mShowSoftInputRunnable = new PreferenceGroup.AnonymousClass1(2, this);
    ...
    public final void scheduleShowSoftInputInner() {
        ...
        if (j != -1 && j + 1000 > SystemClock.currentThreadTimeMillis()) {
            ...
            if (editText == null || !editText.isFocused()) {
                ...
                EditText editText2 = this.mEditText;
                PreferenceGroup.AnonymousClass1 r1 = this.mShowSoftInputRunnable;
