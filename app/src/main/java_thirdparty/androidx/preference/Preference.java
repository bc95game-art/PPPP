...
public class Preference implements Comparable<Preference> {
    ...
    public void onAttached() {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            StringBuilder m = ViewModelProvider.Factory.CC.m15m("Dependency \"", str, "\" not found for preference \"");
            m.append(this.mKey);
            m.append("\" (title: \"");
    ...
    */
    ...
    public Preference(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, CamUtils.getAttr(context, R.attr.preferenceStyle, 16842894));
    }
}
