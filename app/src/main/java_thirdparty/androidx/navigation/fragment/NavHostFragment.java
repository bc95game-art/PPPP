...
public class NavHostFragment extends Fragment {
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        if (view instanceof ViewGroup) {
            ...
            view.setTag(R.id.nav_controller_view_tag, (NavHostController) synchronizedLazyImpl.getValue());
            ...
            if (viewGroup.getParent() != null) {
                ...
                if (view2.getId() == getId()) {
                    ...
                    view3.setTag(R.id.nav_controller_view_tag, (NavHostController) synchronizedLazyImpl.getValue());
                    return;
                }
                return;
            }
