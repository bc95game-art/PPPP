        ...
        fragmentManager.mBackStackChangeListeners.add(new FragmentManager.OnBackStackChangedListener() { // from class: androidx.navigation.fragment.FragmentNavigator$onAttach$2
            ...
            public final void onBackStackChangeCommitted(Fragment fragment, boolean z) {
                ...
                if (!z && !z3 && navBackStackEntry == null) {
                    throw new IllegalArgumentException(ViewModelProvider.Factory.CC.m("The fragment ", fragment, " is unknown to the FragmentNavigator. Please use the navigate() function to add fragments to the FragmentNavigator managed FragmentManager.").toString());
    ...
    public final void popBackStack(NavBackStackEntry navBackStackEntry, boolean z) {
        ...
        while (true) {
            ...
            if (it.hasNext()) {
                ...
                String str = navBackStackEntry4.id;
                ...
                if (z2 || !Intrinsics.areEqual(navBackStackEntry4.id, navBackStackEntry2.id)) {
                    z3 = true;
                }
                if (z3) {
                    arrayList.add(next);
                ...
                while (i3 < size) {
                    ...
                    i3++;
                    addPendingOps$default(this, ((NavBackStackEntry) obj).id, 4);
                }
                if (z) {
                    for (NavBackStackEntry navBackStackEntry5 : CollectionsKt.reversed(subList)) {
                        if (Intrinsics.areEqual(navBackStackEntry5, navBackStackEntry2)) {
                            ...
                            fragmentManager.enqueueAction(new FragmentManager.SaveBackStackState(fragmentManager, navBackStackEntry5.id, 0), false);
                            this.savedIds.add(navBackStackEntry5.id);
                        }
                    }
                } else {
                    fragmentManager.enqueueAction(new FragmentManager.PopBackStackState(navBackStackEntry.id, -1), false);
                }
                if (isLoggingEnabled()) {
