...
public abstract class NavType {
    ...
    public class SerializableType extends NavType {
        ...
        @Override // androidx.navigation.NavType
        /* renamed from: parseValue */
        public Serializable mo19parseValue(String value) {
            Intrinsics.checkNotNullParameter(value, "value");
    ...
    public Object parseValue(Object obj, String str) {
        return mo19parseValue(str);
    }

    /* renamed from: parseValue */
    public abstract Object mo19parseValue(String str);
    ...
    public final class EnumType extends SerializableType {
        ...
        @Override // androidx.navigation.NavType.SerializableType, androidx.navigation.NavType
        /* renamed from: parseValue */
        public final Enum mo19parseValue(String value) {
            Enum r5;
            Intrinsics.checkNotNullParameter(value, "value");
            Class cls = this.type;
            ...
            StringBuilder m = ViewModelProvider.Factory.CC.m15m("Enum value ", value, " not found for type ");
