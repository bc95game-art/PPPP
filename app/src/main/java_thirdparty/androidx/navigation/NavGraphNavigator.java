    ...
    public final void navigate(List list, NavOptions navOptions) {
        ...
        while (it.hasNext()) {
            ...
            if (i == 0) {
                ...
                if (((NavDestination) ((NavGraph) zzcaVar.zza)).impl.id == 0) {
            ...
            if (navDestination2 == null) {
                ...
                throw new IllegalArgumentException(ViewModelProvider.Factory.CC.m("navigation destination ", str, " is not a direct child of this NavGraph"));
            }
