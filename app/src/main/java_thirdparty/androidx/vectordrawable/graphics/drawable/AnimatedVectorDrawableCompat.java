...
public final class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable {
    ...
    */
    ...
    public final void registerAnimationCallback(MaterialCheckBox.AnonymousClass1 r3) {
        Drawable drawable = this.mDelegateDrawable;
        if (drawable != null) {
            ...
            if (!this.mAnimationCallbacks.contains(r3)) {
                ...
                if (this.mAnimatorListener == null) {
                    this.mAnimatorListener = new Transition.AnonymousClass3(3, this);
                }
    ...
    public final void unregisterAnimationCallback(MaterialCheckBox.AnonymousClass1 r3) {
        Transition.AnonymousClass3 r32;
        Drawable drawable = this.mDelegateDrawable;
        if (drawable != null) {
            AnimatedVectorDrawable animatedVectorDrawable = (AnimatedVectorDrawable) drawable;
            if (r3.mPlatformCallback == null) {
