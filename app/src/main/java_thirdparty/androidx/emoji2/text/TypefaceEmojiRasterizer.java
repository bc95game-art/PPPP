...
public final class TypefaceEmojiRasterizer {
    ...
    public final MetadataItem getMetadataItem() {
        ...
        if (__offset != 0) {
            ...
            if (byteBuffer != null) {
                ...
                metadataItem2.vtable_size = ((ByteBuffer) metadataItem2.bb).getShort(i4);
    ...
    public final String toString() {
        ...
        if (__offset != 0) {
            i = ((ByteBuffer) metadataItem.bb).getInt(__offset + metadataItem.bb_pos);
        } else {
            i = 0;
        }
        ...
        if (__offset2 != 0) {
            ...
            i2 = ((ByteBuffer) metadataItem2.bb).getInt(((ByteBuffer) metadataItem2.bb).getInt(i3) + i3);
        } else {
            i2 = 0;
        }
