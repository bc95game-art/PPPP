...
public abstract class AppCompatActivity extends FragmentActivity implements AppCompatCallback, TaskStackBuilder.SupportParentable, ActionBarDrawerToggle.DelegateProvider {
    ...
    public AppCompatActivity() {
        getSavedStateRegistry().registerSavedStateProvider(DELEGATE_TAG, new AnonymousClass1(this));
    ...
    public ActionBarDrawerToggle.Delegate getDrawerToggleDelegate() {
        ...
        return new AppCompatDelegateImpl.AnonymousClass3(appCompatDelegateImpl, 2);
    }
        ...
        public final Bundle saveState() {
            switch (this.$r8$classId) {
                ...
                default:
                    ...
                    Navigation.m26putStringListimpl(bundleOf, "classes_to_restore", CollectionsKt.toList((LinkedHashSet) this.this$0));
                    return bundleOf;
            }
        }
