...
public class AppCompatViewInflater {
            ...
            if (this.mResolvedMethod == null) {
                ...
                while (true) {
                    ...
                    if (context != null) {
                        ...
                        StringBuilder m = ViewModelProvider.Factory.CC.m15m("Could not find method ", str2, "(View) in a parent or ancestor Context for android:onClick attribute defined on view ");
    ...
    public AppCompatCheckBox createCheckBox(Context context, AttributeSet attributeSet) {
        return new AppCompatCheckBox(context, attributeSet, R.attr.checkboxStyle);
    }
