...
public final class SupportMenuInflater extends MenuInflater {
    ...
    public final class MenuState {
        ...
        public final void setItem(MenuItem menuItem) {
            ...
            if (this.itemListenerMethodName != null) {
                if (!context.isRestricted()) {
                    ...
                    try {
                        ...
                        StringBuilder m = ViewModelProvider.Factory.CC.m15m("Couldn't resolve menu item onClick handler ", str, " in class ");
            ...
            if (z3) {
                ((SupportMenuItem) menuItem).mo1setContentDescription(charSequence);
            ...
            if (z3) {
                ((SupportMenuItem) menuItem).mo2setTooltipText(charSequence2);
            } else if (Build.VERSION.SDK_INT >= 26) {
