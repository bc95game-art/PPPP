...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    public ToolbarActionBar.AnonymousClass2 mMenuBuilderCallback;
    ...
    /* loaded from: classes.dex */
    public final class AnonymousClass1 implements ActionMenuView.OnMenuItemClickListener, MenuBuilder.Callback {
        ...
        public void onMenuModeChange(MenuBuilder menuBuilder) {
            ...
            ToolbarActionBar.AnonymousClass2 r0 = toolbar.mMenuBuilderCallback;
            if (r0 != null) {
            ...
            switch (this.$r8$classId) {
                ...
                case 4:
                    ...
                    if (i == 2) {
                        ...
                        materialCalendar.recyclerView.announceForAccessibility(materialCalendar.getString(R.string.mtrl_picker_toggled_to_day_selection));
                        return;
                    } else if (i == 1) {
                        materialCalendar.setSelector$1(2);
                        materialCalendar.yearSelector.announceForAccessibility(materialCalendar.getString(R.string.mtrl_picker_toggled_to_year_selection));
                        return;
                    } else {
                        return;
                    }
    ...
    */
    ...
    public Toolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        MatcherMatchResult obtainStyledAttributes = MatcherMatchResult.obtainStyledAttributes(context2, attributeSet, iArr, R.attr.toolbarStyle);
        ViewCompat.saveAttributeDataForStyleable(this, context, iArr, attributeSet, (TypedArray) obtainStyledAttributes.input, R.attr.toolbarStyle);
