...
public final class AppCompatSeekBarHelper extends AppCompatProgressBarHelper {
    ...
    public final void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        MatcherMatchResult obtainStyledAttributes = MatcherMatchResult.obtainStyledAttributes(context, attributeSet, iArr, R.attr.seekBarStyle);
        TypedArray typedArray = (TypedArray) obtainStyledAttributes.input;
        ViewCompat.saveAttributeDataForStyleable(appCompatSeekBar, appCompatSeekBar.getContext(), iArr, attributeSet, (TypedArray) obtainStyledAttributes.input, R.attr.seekBarStyle);
