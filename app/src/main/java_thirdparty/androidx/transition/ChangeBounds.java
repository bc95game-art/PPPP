                    ...
                    if (i14 > 0) {
                        ...
                        if (i14 != 2) {
                            ...
                            if (i2 == i3 && i4 == i5) {
                                ...
                                objectAnimator = ObjectAnimatorUtils$Api21Impl.ofObject(view, BOTTOM_RIGHT_ONLY_PROPERTY, Transition.AnonymousClass1.getPath(i6, i8, i7, i9));
                            } else {
                                changeBounds.mPathMotion.getClass();
                                objectAnimator = ObjectAnimatorUtils$Api21Impl.ofObject(view, TOP_LEFT_ONLY_PROPERTY, Transition.AnonymousClass1.getPath(i2, i4, i3, i5));
                            }
                        } else if (i10 == i12 && i11 == i13) {
                            changeBounds = this;
                            changeBounds.mPathMotion.getClass();
                            objectAnimator = ObjectAnimatorUtils$Api21Impl.ofObject(view, POSITION_PROPERTY, Transition.AnonymousClass1.getPath(i2, i4, i3, i5));
                        } else {
                            changeBounds = this;
                            ViewBounds viewBounds = new ViewBounds(view);
                            changeBounds.mPathMotion.getClass();
                            ObjectAnimator ofObject = ObjectAnimatorUtils$Api21Impl.ofObject(viewBounds, TOP_LEFT_PROPERTY, Transition.AnonymousClass1.getPath(i2, i4, i3, i5));
                            changeBounds.mPathMotion.getClass();
                            ObjectAnimator ofObject2 = ObjectAnimatorUtils$Api21Impl.ofObject(viewBounds, BOTTOM_RIGHT_PROPERTY, Transition.AnonymousClass1.getPath(i6, i8, i7, i9));
