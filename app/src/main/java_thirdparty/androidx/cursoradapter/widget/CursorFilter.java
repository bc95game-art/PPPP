...
public final class CursorFilter extends Filter {
    ...
    */
    public final android.widget.Filter.FilterResults performFiltering(java.lang.CharSequence r5) {
        /*
            r4 = this;
            androidx.cursoradapter.widget.CursorAdapter r0 = r4.mClient
        ...
        Lf:
            ...
            goto L31
        L1d:
            android.app.SearchableInfo r1 = r0.mSearchable     // Catch: java.lang.RuntimeException -> L29
            android.database.Cursor r5 = r0.getSearchManagerSuggestions(r1, r5)     // Catch: java.lang.RuntimeException -> L29
            if (r5 == 0) goto L31
