    ...
    public static int[] convertReferenceString(Barrier barrier, String str) {
        ...
        while (i2 < split.length) {
            ...
            if (i == 0 && barrier.isInEditMode() && (barrier.getParent() instanceof ConstraintLayout)) {
                ...
                if (ViewModelProvider.Factory.CC.m((Object) trim)) {
                                ...
                                switch (ordinal) {
                                    ...
                                    case 7:
                                        ...
                                        try {
                                            ...
                                            e2 = e4;
                                            StringBuilder m = ViewModelProvider.Factory.CC.m15m(" Custom Attribute \"", str4, "\" not found on ");
                                            ...
                                            e3 = e6;
                                            StringBuilder m2 = ViewModelProvider.Factory.CC.m15m(" Custom Attribute \"", str4, "\" not found on ");
                ...
                if (constraint == null) {
                    ...
                    for (String str : hashMap4.keySet()) {
                        ...
                        try {
                            ...
                            StringBuilder m = ViewModelProvider.Factory.CC.m15m(" Custom Attribute \"", str, "\" not found on ");
                            m.append(cls.getName());
                            Log.e("TransitionLayout", m.toString(), e);
                        } catch (NoSuchMethodException e2) {
                            Log.e("TransitionLayout", cls.getName() + " must have a method " + str, e2);
                        } catch (InvocationTargetException e3) {
                            StringBuilder m2 = ViewModelProvider.Factory.CC.m15m(" Custom Attribute \"", str, "\" not found on ");
                            m2.append(cls.getName());
                            Log.e("TransitionLayout", m2.toString(), e3);
                        }
                        hashMap4 = hashMap5;
