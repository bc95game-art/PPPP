...
public abstract class PreferenceFragmentCompat extends Fragment {
    ...
    private int mLayoutResId = C0130R.layout.preference_list_fragment;
    private final Handler mHandler = new HandlerC00901(this, Looper.getMainLooper());
    private final Runnable mRequestFocus = new PreferenceGroup.RunnableC00921(1, this);

    /* renamed from: androidx.preference.PreferenceFragmentCompat$1 */
    /* loaded from: classes.dex */
    public final class HandlerC00901 extends Handler {
        public final /* synthetic */ int $r8$classId = 1;
        public Object this$0;

        public /* synthetic */ HandlerC00901() {
        }
        ...
        public HandlerC00901(PreferenceFragmentCompat preferenceFragmentCompat, Looper looper) {
            super(looper);
    ...
    /* loaded from: classes.dex */
    public final class RunnableC00913 implements Runnable {
        public final /* synthetic */ String val$key;
        public final /* synthetic */ Preference val$preference;

        public RunnableC00913(Preference preference, String str) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        requireContext().getTheme().resolveAttribute(C0130R.attr.preferenceTheme, typedValue, true);
        int i = typedValue.resourceId;
        if (i == 0) {
            i = C0130R.style.PreferenceThemeOverlay;
        }
    ...
    public RecyclerView onCreateRecyclerView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (requireContext().getPackageManager().hasSystemFeature("android.hardware.type.automotive") && (recyclerView = (RecyclerView) viewGroup.findViewById(C0130R.C0132id.recycler_view)) != null) {
            return recyclerView;
        }
        RecyclerView recyclerView2 = (RecyclerView) layoutInflater.inflate(C0130R.layout.preference_recyclerview, viewGroup, false);
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        TypedArray obtainStyledAttributes = requireContext().obtainStyledAttributes(null, R$styleable.PreferenceFragmentCompat, C0130R.attr.preferenceFragmentCompatStyle, 0);
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        FragmentManager.C00753 fragmentFactory = parentFragmentManager.getFragmentFactory();
    ...
    public void scrollToPreference(Preference preference) {
        RunnableC00913 r0 = new RunnableC00913(preference, null);
        if (this.mList == null) {
    ...
    public void setPreferencesFromResource(int i, String str) {
        ...
        if (preferenceManager != null) {
            ...
            if (str != null) {
                ...
                if (!z) {
                    throw new IllegalArgumentException(ViewModelProvider.Factory.CC.m595m("Preference object with key ", str, " is not a PreferenceScreen"));
                }
            }
    ...
    public void scrollToPreference(String str) {
        RunnableC00913 r0 = new RunnableC00913(null, str);
        if (this.mList == null) {
            this.mSelectPreferenceRunnable = r0;
        } else {
            r0.run();
