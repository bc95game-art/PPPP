...
public final class PreferenceGroupAdapter extends RecyclerView.Adapter {
    ...
    public final PreferenceGroup.RunnableC00921 mSyncRunnable = new PreferenceGroup.RunnableC00921(3, this);
    ...
    public final ArrayList createVisiblePreferencesList(PreferenceGroup preferenceGroup) {
        ...
        if (i6 != Integer.MAX_VALUE && i > i6) {
            ...
            preference3.mLayoutResId = C0130R.layout.expand_button;
            Context context2 = preference3.mContext;
            Drawable drawable = BundleKt.getDrawable(context2, C0130R.C0131drawable.ic_arrow_down_24dp);
            if (preference3.mIcon != drawable) {
                preference3.mIcon = drawable;
                preference3.mIconResId = 0;
                preference3.notifyChanged();
            }
            preference3.mIconResId = C0130R.C0131drawable.ic_arrow_down_24dp;
            String string = context2.getString(C0130R.string.expand_button_title);
            ...
            if (999 != preference3.mOrder) {
                ...
                if (preferenceGroupAdapter != null) {
                    ...
                    PreferenceGroup.RunnableC00921 r10 = preferenceGroupAdapter.mSyncRunnable;
            ...
            while (i7 < size3) {
                ...
                if (arrayList3.contains(preference4.mParentGroup)) {
                    ...
                    if (str == null) {
                        ...
                        str = context2.getString(C0130R.string.summary_collapsed_preference_list, objArr);
                    }
                }
            }
