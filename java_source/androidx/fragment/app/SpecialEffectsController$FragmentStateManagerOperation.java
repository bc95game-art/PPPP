...
public final class SpecialEffectsController$FragmentStateManagerOperation {
    ...
    public SpecialEffectsController$FragmentStateManagerOperation(int i, int i2, FragmentStateManager fragmentStateManager) {
        ViewModelProvider.Factory.CC.m603m(i, "finalState");
        ViewModelProvider.Factory.CC.m603m(i2, "lifecycleImpact");
    ...
    public final String toString() {
        StringBuilder m = ViewModelProvider.Factory.CC.m594m("Operation {", Integer.toHexString(System.identityHashCode(this)), "} {finalState = ");
