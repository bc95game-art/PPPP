...
public final class SavedStateRegistry {
    ...
    public AppCompatActivity.C00121 recreatorProvider;
    ...
    public final void runOnNextRecreation() {
        if (this.impl.isAllowingSavingState) {
            AppCompatActivity.C00121 r1 = this.recreatorProvider;
            if (r1 == null) {
                r1 = new AppCompatActivity.C00121(this);
            }
            this.recreatorProvider = r1;
            try {
                LegacySavedStateHandleController$OnRecreation.class.getDeclaredConstructor(null);
                AppCompatActivity.C00121 r12 = this.recreatorProvider;
                if (r12 != null) {
