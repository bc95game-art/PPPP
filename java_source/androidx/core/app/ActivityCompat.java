...
public abstract class ActivityCompat extends BundleKt {
    ...
    /* loaded from: classes.dex */
    public final class RunnableC00421 implements Runnable {
        public final /* synthetic */ int $r8$classId;
        public final /* synthetic */ Object val$activity;
        public final /* synthetic */ Object val$permissionsArray;
        public final /* synthetic */ int val$requestCode;

        public /* synthetic */ RunnableC00421(int i, int i2, Object obj, Object obj2) {
            this.$r8$classId = i2;
        ...
        public final void run() {
            ...
            switch (this.$r8$classId) {
                case 0:
                    ...
                    return;
                case 1:
                    ComponentActivity.C00001 r0 = (ComponentActivity.C00001) this.val$activity;
                ...
                case 2:
                    ((ComponentActivity.C00001) this.val$activity).dispatchResult(this.val$requestCode, 0, new Intent().setAction("androidx.activity.result.contract.action.INTENT_SENDER_REQUEST").putExtra("androidx.activity.result.contract.extra.SEND_INTENT_EXCEPTION", (IntentSender.SendIntentException) this.val$permissionsArray));
                    return;
                case 3:
        ...
        public /* synthetic */ RunnableC00421(ComponentActivity.C00001 r1, int i, Object obj, int i2) {
            this.$r8$classId = i2;
        ...
        public RunnableC00421(BottomSheetBehavior bottomSheetBehavior, View view, int i) {
            this.$r8$classId = 4;
    ...
    public static void requestPermissions(Activity activity, String[] strArr, int i) {
        ...
        for (int i2 = 0; i2 < strArr.length; i2++) {
            if (!TextUtils.isEmpty(strArr[i2])) {
                ...
                throw new IllegalArgumentException(ViewModelProvider.Factory.CC.m593m(new StringBuilder("Permission request for permissions "), Arrays.toString(strArr), " must not contain null or empty values"));
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            new Handler(Looper.getMainLooper()).post(new RunnableC00421(i, 0, strArr2, activity));
        }
    }
