...
public abstract class ViewCompat {
    ...
    public static final int[] ACCESSIBILITY_ACTIONS_RESOURCE_IDS = {C0130R.C0132id.accessibility_custom_action_0, C0130R.C0132id.accessibility_custom_action_1, C0130R.C0132id.accessibility_custom_action_2, C0130R.C0132id.accessibility_custom_action_3, C0130R.C0132id.accessibility_custom_action_4, C0130R.C0132id.accessibility_custom_action_5, C0130R.C0132id.accessibility_custom_action_6, C0130R.C0132id.accessibility_custom_action_7, C0130R.C0132id.accessibility_custom_action_8, C0130R.C0132id.accessibility_custom_action_9, C0130R.C0132id.accessibility_custom_action_10, C0130R.C0132id.accessibility_custom_action_11, C0130R.C0132id.accessibility_custom_action_12, C0130R.C0132id.accessibility_custom_action_13, C0130R.C0132id.accessibility_custom_action_14, C0130R.C0132id.accessibility_custom_action_15, C0130R.C0132id.accessibility_custom_action_16, C0130R.C0132id.accessibility_custom_action_17, C0130R.C0132id.accessibility_custom_action_18, C0130R.C0132id.accessibility_custom_action_19, C0130R.C0132id.accessibility_custom_action_20, C0130R.C0132id.accessibility_custom_action_21, C0130R.C0132id.accessibility_custom_action_22, C0130R.C0132id.accessibility_custom_action_23, C0130R.C0132id.accessibility_custom_action_24, C0130R.C0132id.accessibility_custom_action_25, C0130R.C0132id.accessibility_custom_action_26, C0130R.C0132id.accessibility_custom_action_27, C0130R.C0132id.accessibility_custom_action_28, C0130R.C0132id.accessibility_custom_action_29, C0130R.C0132id.accessibility_custom_action_30, C0130R.C0132id.accessibility_custom_action_31};
    ...
    /* loaded from: classes.dex */
    public final class C00461 extends Table {
        public final /* synthetic */ int $r8$classId;

        public C00461(int i, Class cls, int i2, int i3, int i4) {
            this.$r8$classId = i4;
            this.bb_pos = i;
            this.f9bb = cls;
            this.vtable_size = i2;
    ...
    public abstract class Api21Impl {
        public static void callCompatInsetAnimationCallback(WindowInsets windowInsets, View view) {
            View.OnApplyWindowInsetsListener onApplyWindowInsetsListener = (View.OnApplyWindowInsetsListener) view.getTag(C0130R.C0132id.tag_window_insets_animation_callback);
                ...
                try {
                    ...
                    if (obj != null) {
                        ...
                        if (!(rect == null || rect2 == null)) {
                            ...
                            builderImpl.setStableInsets(Insets.m620of(rect.left, rect.top, rect.right, rect.bottom));
                            builderImpl.setSystemWindowInsets(Insets.m620of(rect2.left, rect2.top, rect2.right, rect2.bottom));
        ...
        public static void setOnApplyWindowInsetsListener(final View view, final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
            if (Build.VERSION.SDK_INT < 30) {
                view.setTag(C0130R.C0132id.tag_on_apply_window_listener, onApplyWindowInsetsListener);
            }
            if (onApplyWindowInsetsListener == null) {
                view.setOnApplyWindowInsetsListener((View.OnApplyWindowInsetsListener) view.getTag(C0130R.C0132id.tag_window_insets_animation_callback));
            } else {
    ...
    public abstract class Api28Impl {
        ...
        public static void addOnUnhandledKeyEventListener(View view, OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
            SimpleArrayMap simpleArrayMap = (SimpleArrayMap) view.getTag(C0130R.C0132id.tag_unhandled_key_listeners);
            SimpleArrayMap simpleArrayMap2 = simpleArrayMap;
            if (simpleArrayMap == null) {
                SimpleArrayMap simpleArrayMap3 = new SimpleArrayMap(0);
                view.setTag(C0130R.C0132id.tag_unhandled_key_listeners, simpleArrayMap3);
    ...
    public final class UnhandledKeyEventManager {
        ...
        public final View dispatchInOrder(View view) {
            ...
            ArrayList arrayList = (ArrayList) view.getTag(C0130R.C0132id.tag_unhandled_key_listeners);
    ...
    public static boolean dispatchUnhandledKeyEventBeforeCallback(View view, KeyEvent keyEvent) {
        ...
        UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0130R.C0132id.tag_unhandled_key_event_manager);
    ...
    public static CharSequence getAccessibilityPaneTitle(View view) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            obj = view.getTag(C0130R.C0132id.tag_accessibility_pane_title);
    ...
    public static ArrayList getActionList(View view) {
        ArrayList arrayList = (ArrayList) view.getTag(C0130R.C0132id.tag_accessibility_actions);
        if (arrayList != null) {
            return arrayList;
        }
        ArrayList arrayList2 = new ArrayList();
        view.setTag(C0130R.C0132id.tag_accessibility_actions, arrayList2);
        return arrayList2;
    }
    ...
    public static String[] getOnReceiveContentMimeTypes(AppCompatEditText appCompatEditText) {
        ...
        return (String[]) appCompatEditText.getTag(C0130R.C0132id.tag_on_receive_content_mime_types);
    }
    ...
    public static ContentInfoCompat performReceiveContent(View view, ContentInfoCompat contentInfoCompat) {
        ...
        OnReceiveContentListener onReceiveContentListener = (OnReceiveContentListener) view.getTag(C0130R.C0132id.tag_on_receive_content_listener);
    ...
    public static void setAccessibilityPaneTitle(View view, CharSequence charSequence) {
        boolean z;
        new C00461(C0130R.C0132id.tag_accessibility_pane_title, CharSequence.class, 8, 28, 1).set(view, charSequence);
