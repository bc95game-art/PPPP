...
public final class WindowInsetsAnimationCompat {
    ...
    public final class Impl21 extends Impl {
        ...
        public final class Impl21OnApplyWindowInsetsListener implements View.OnApplyWindowInsetsListener {
            ...
            public final WindowInsets onApplyWindowInsets(final View view, WindowInsets windowInsets) {
                ...
                zzcl zzclVar = new zzcl(Insets.m620of(min, min2, min3, Math.min(i7, i9)), 9, Insets.m620of(Math.max(insets.left, insets2.left), Math.max(i3, i4), Math.max(i5, i6), Math.max(i7, i9)));
                ...
                duration.addListener(new Transition.C01112(view, 1, windowInsetsAnimationCompat));
        ...
        public static WindowInsets forwardToViewIfNeeded(View view, WindowInsets windowInsets) {
            if (view.getTag(C0130R.C0132id.tag_on_apply_window_listener) != null) {
                return windowInsets;
            }
        ...
        public static ContentInfoCompat.CompatImpl getCallback(View view) {
            Object tag = view.getTag(C0130R.C0132id.tag_window_insets_animation_callback);
    ...
    public final class Impl30 extends Impl {
        ...
        public final class ProxyCallback extends WindowInsetsAnimation.Callback {
            ...
            public final WindowInsetsAnimation.Bounds onStart(WindowInsetsAnimation windowInsetsAnimation, WindowInsetsAnimation.Bounds bounds) {
                ...
                AbstractC0049x6f32a476.m612m();
                return AbstractC0049x6f32a476.m610m(lowerBounds.toPlatformInsets(), higherBounds.toPlatformInsets());
            }
        }
    ...
    public WindowInsetsAnimationCompat(int i, Interpolator interpolator, long j) {
        if (Build.VERSION.SDK_INT >= 30) {
            this.mImpl = new Impl30(AbstractC0049x6f32a476.m611m(i, interpolator, j));
        } else {
