...
public final class WindowInsetsCompat {
    ...
    public abstract class Impl20 extends Impl {
            ...
            if (Build.VERSION.SDK_INT < 30) {
                ...
                if (!(method == null || sAttachInfoClass == null || sVisibleInsetsField == null)) {
                    try {
                        ...
                        if (rect != null) {
                            return Insets.m620of(rect.left, rect.top, rect.right, rect.bottom);
                        }
                    } catch (ReflectiveOperationException e) {
            ...
            if (i != 1) {
                ...
                if (i != 2) {
                    ...
                    if (i == 8) {
                        ...
                        return Insets.m620of(i3, i4, i5, i6);
                    }
                } else if (z) {
                    Insets rootStableInsets2 = getRootStableInsets();
                    Insets stableInsets = getStableInsets();
                    return Insets.m620of(Math.max(rootStableInsets2.left, stableInsets.left), 0, Math.max(rootStableInsets2.right, stableInsets.right), Math.max(rootStableInsets2.bottom, stableInsets.bottom));
                } else {
                    ...
                    return Insets.m620of(systemWindowInsets2.left, 0, systemWindowInsets2.right, i9);
                }
            } else if (z) {
                return Insets.m620of(0, Math.max(getRootStableInsets().top, getSystemWindowInsets().top), 0, 0);
            } else {
                return Insets.m620of(0, getSystemWindowInsets().top, 0, 0);
            }
        }
        ...
        public final Insets getSystemWindowInsets() {
            if (this.mSystemWindowInsets == null) {
                ...
                this.mSystemWindowInsets = Insets.m620of(windowInsets.getSystemWindowInsetLeft(), windowInsets.getSystemWindowInsetTop(), windowInsets.getSystemWindowInsetRight(), windowInsets.getSystemWindowInsetBottom());
            }
    ...
    public class Impl21 extends Impl20 {
        ...
        public final Insets getStableInsets() {
            if (this.mStableInsets == null) {
                WindowInsets windowInsets = this.mPlatformInsets;
                this.mStableInsets = Insets.m620of(windowInsets.getStableInsetLeft(), windowInsets.getStableInsetTop(), windowInsets.getStableInsetRight(), windowInsets.getStableInsetBottom());
            }
    ...
    public static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        return Insets.m620of(max, max2, max3, max4);
    }
    ...
    public final WindowInsetsCompat replaceSystemWindowInsets(int i, int i2, int i3, int i4) {
        ...
        builderImpl.setSystemWindowInsets(Insets.m620of(i, i2, i3, i4));
        return builderImpl.build();
    }
    ...
    public class BuilderImpl29 extends BuilderImpl {
        ...
        public BuilderImpl29() {
            this.mPlatBuilder = AbstractC0050xad760191.m609m();
        }
        ...
        public BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            ...
            if (windowInsets != null) {
                builder = AbstractC0050xad760191.m608m(windowInsets);
            } else {
                builder = AbstractC0050xad760191.m609m();
            }
