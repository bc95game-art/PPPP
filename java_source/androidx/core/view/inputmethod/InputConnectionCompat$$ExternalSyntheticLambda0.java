    ...
    public CctTransportBackend.HttpResponse apply(MatcherMatchResult matcherMatchResult) {
        ...
        try {
            ...
            try {
                ...
                Navigation.m590d("CctTransportBackend", "Content-Type: %s", httpURLConnection.getHeaderField("Content-Type"));
                Navigation.m590d("CctTransportBackend", "Content-Encoding: %s", httpURLConnection.getHeaderField("Content-Encoding"));
            ...
            e = e2;
            Navigation.m589e("CctTransportBackend", "Couldn't encode request, returning with 400", e);
            return new CctTransportBackend.HttpResponse(400, null, 0L);
        } catch (ConnectException e3) {
            e = e3;
            Navigation.m589e("CctTransportBackend", "Couldn't open connection, returning with 500", e);
