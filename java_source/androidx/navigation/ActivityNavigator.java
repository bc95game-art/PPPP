...
public class ActivityNavigator extends Navigator {
    ...
    public final NavDestination navigate(NavDestination navDestination, Bundle bundle, NavOptions navOptions) {
        ...
        if (destination.intent != null) {
            ...
            intent2.putExtra("android-support-navigation:ActivityNavigator:current", navDestinationImpl.f12id);
        ...
        throw new IllegalStateException(("Destination " + navDestinationImpl.f12id + " does not have an Intent set.").toString());
    }
