...
public abstract class ActivityResultRegistry {
    ...
    /* loaded from: classes.dex */
    public final class C00062 extends ActivityResultLauncher {
        ...
        public /* synthetic */ C00062(ActivityResultRegistry activityResultRegistry, String str, ActivityResultContract activityResultContract, int i) {
            this.$r8$classId = i;
    ...
    public final C00062 register(final String str, LifecycleOwner lifecycleOwner, final ActivityResultContract activityResultContract, final ActivityResultCallback activityResultCallback) {
        ...
        if (lifecycleRegistry.state.compareTo(Lifecycle.State.STARTED) < 0) {
            ...
            return new C00062(this, str, activityResultContract, 0);
        }
    ...
    public final void unregister(String str) {
        ...
        if (hashMap.containsKey(str)) {
            StringBuilder m = ViewModelProvider.Factory.CC.m594m("Dropping pending result for request ", str, ": ");
        ...
        if (bundle.containsKey(str)) {
            StringBuilder m2 = ViewModelProvider.Factory.CC.m594m("Dropping pending result for request ", str, ": ");
    ...
    public final C00062 register(String str, ActivityResultContract activityResultContract, ActivityResultCallback activityResultCallback) {
        registerKey(str);
        ...
        return new C00062(this, str, activityResultContract, 1);
    }
}
