...
public final /* synthetic */ class ComponentActivity$$ExternalSyntheticLambda2 implements SavedStateRegistry.SavedStateProvider {
    ...
    public final Bundle saveState() {
        ...
        switch (i) {
            case 0:
                return ComponentActivity.m631$r8$lambda$71Q7mCYu4mmbnahJ05KgHel0((ComponentActivity) obj);
            case 1:
            ...
            case 2:
                ...
                for (Map.Entry entry4 : MapsKt__MapsKt.toMap(navControllerImpl._navigatorProvider._navigators).entrySet()) {
                    ...
                    if (onSaveState != null) {
                        arrayList2.add(str);
                        Navigation.m654putSavedStateimpl(bundleOf, str, onSaveState);
                    }
                }
                if (!arrayList2.isEmpty()) {
                    bundle = BundleKt.bundleOf((Pair[]) Arrays.copyOf(new Pair[0], 0));
                    Navigation.m656putStringListimpl(bundleOf, "android-support-nav:controller:navigatorState:names", arrayList2);
                    Navigation.m654putSavedStateimpl(bundle, "android-support-nav:controller:navigatorState", bundleOf);
                } else {
                    bundle = null;
                }
                if (!arrayDeque.isEmpty()) {
                    ...
                    while (it.hasNext()) {
                        ...
                        int i2 = entry5.destination.impl.f12id;
                        String str2 = entry5.f10id;
                        ...
                        Navigation.m655putStringimpl(bundleOf3, "nav-entry-state:id", str2);
                        ...
                        Navigation.m654putSavedStateimpl(bundleOf3, "nav-entry-state:args", arguments$navigation_common_release);
                        Navigation.m654putSavedStateimpl(bundleOf3, "nav-entry-state:saved-state", bundleOf2);
                ...
                if (!linkedHashMap3.isEmpty()) {
                    ...
                    Navigation.m656putStringListimpl(bundle, "android-support-nav:controller:backStackIds", arrayList4);
                }
                if (!linkedHashMap2.isEmpty()) {
                    ...
                    for (Map.Entry entry7 : linkedHashMap2.entrySet()) {
                        ...
                        while (it2.hasNext()) {
                            ...
                            Navigation.m655putStringimpl(bundleOf4, "nav-entry-state:id", (String) zzcaVar.zza);
                            ...
                            Navigation.m654putSavedStateimpl(bundleOf4, "nav-entry-state:args", bundle2);
                            Navigation.m654putSavedStateimpl(bundleOf4, "nav-entry-state:saved-state", (Bundle) zzcaVar.zzc);
                    ...
                    Navigation.m656putStringListimpl(bundle, "android-support-nav:controller:backStackStates", arrayList5);
                }
