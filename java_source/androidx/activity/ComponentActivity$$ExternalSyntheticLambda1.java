                ...
                if (context != null) {
                    ...
                    if (consumeRestoredStateForKey != null) {
                        ...
                        if (consumeRestoredStateForKey.containsKey("android-support-nav:controller:backStack")) {
                            bundleArr = (Bundle[]) Navigation.m651getSavedStateListimpl(consumeRestoredStateForKey, "android-support-nav:controller:backStack").toArray(new Bundle[0]);
                        } else {
                            bundleArr = null;
                        }
                            ...
                            if (stringArrayList2 != null) {
                                ...
                                while (i7 < size) {
                                    ...
                                    if (consumeRestoredStateForKey.containsKey(key)) {
                                        ArrayList arrayList = Navigation.m651getSavedStateListimpl(consumeRestoredStateForKey, "android-support-nav:controller:backStackStates:" + str5);
