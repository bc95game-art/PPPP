...
public final class VersionedParcelParcel extends VersionedParcel {
    ...
    public final VersionedParcelParcel createSubParcel() {
        ...
        return new VersionedParcelParcel(parcel, dataPosition, i, ViewModelProvider.Factory.CC.m593m(new StringBuilder(), this.mPrefix, "  "), this.mReadCache, this.mWriteCache, this.mParcelizerCache);
    }
