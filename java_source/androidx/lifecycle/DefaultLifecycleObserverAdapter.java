...
public final class DefaultLifecycleObserverAdapter implements LifecycleEventObserver {
    ...
    public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
        ...
        switch (i) {
            case 0:
                EmojiCompatInitializer.C00561 r2 = (EmojiCompatInitializer.C00561) obj2;
            ...
            default:
                if (event == Lifecycle.Event.ON_DESTROY) {
                    ((Handler) obj2).removeCallbacks((FragmentStateAdapter.RunnableC01193) obj);
                    lifecycleOwner.getLifecycle().removeObserver(this);
                    return;
                }
                return;
    ...
    public DefaultLifecycleObserverAdapter(EmojiCompatInitializer.C00561 defaultLifecycleObserver, LifecycleEventObserver lifecycleEventObserver) {
        this.$r8$classId = 0;
