...
public abstract class LiveData {
    ...
    public final RunnableC00851 mPostValueRunnable;
    public int mVersion;
    ...
    public static void assertMainThread(String str) {
        ...
        if (Looper.getMainLooper().getThread() != Thread.currentThread()) {
            throw new IllegalStateException(ViewModelProvider.Factory.CC.m595m("Cannot invoke ", str, " on a background thread"));
        }
    }
