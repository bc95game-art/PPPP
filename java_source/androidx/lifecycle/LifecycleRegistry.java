...
public final class LifecycleRegistry extends Lifecycle {
    ...
    public final void addObserver(LifecycleObserver observer) {
        ...
        boolean z2 = observer instanceof EmojiCompatInitializer.C00561;
        boolean z3 = false;
        if (z && z2) {
            lifecycleEventObserver = new DefaultLifecycleObserverAdapter((EmojiCompatInitializer.C00561) observer, (LifecycleEventObserver) observer);
        } else if (z2) {
            lifecycleEventObserver = new DefaultLifecycleObserverAdapter((EmojiCompatInitializer.C00561) observer, (LifecycleEventObserver) null);
        } else if (z) {
    ...
    public final void enforceMainThreadIfNeeded(String str) {
        if (this.enforceMainThread) {
            ...
            if (Looper.getMainLooper().getThread() != Thread.currentThread()) {
                throw new IllegalStateException(ViewModelProvider.Factory.CC.m595m("Method ", str, " must be called on the main thread").toString());
            }
        }
    }
