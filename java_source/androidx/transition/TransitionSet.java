...
public class TransitionSet extends Transition {
    ...
    /* loaded from: classes.dex */
    public final class C01142 extends TransitionListenerAdapter {
        public final /* synthetic */ int $r8$classId;
        public Transition this$0;

        public /* synthetic */ C01142() {
            this.$r8$classId = 1;
        }
        ...
        public /* synthetic */ C01142(Transition transition, int i) {
            this.$r8$classId = i;
    ...
    public final void runAnimators() {
        ...
        if (!this.mPlayTogether) {
            for (int i3 = 1; i3 < this.mTransitions.size(); i3++) {
                ((Transition) this.mTransitions.get(i3 - 1)).addListener(new C01142((Transition) this.mTransitions.get(i3), 2));
            }
    ...
    */
    public final void setCurrentPlayTimeMillis(long j, long j2) {
        ...
        if (this.mPlayTogether) {
            ...
            int i4 = 1;
            while (true) {
                if (i4 >= this.mTransitions.size()) {
                    i4 = this.mTransitions.size();
                    break;
                } else if (((Transition) this.mTransitions.get(i4)).mSeekOffsetInParent > j2) {
                    break;
                } else {
                    i4++;
                }
            ...
            int i5 = i4 - 1;
            if (i >= 0) {
                while (i5 < this.mTransitions.size()) {
                    Transition transition = (Transition) this.mTransitions.get(i5);
                ...
                j3 = 0;
                while (i5 >= 0) {
                    Transition transition2 = (Transition) this.mTransitions.get(i5);
    ...
    @Override // androidx.transition.Transition
    public final void setPathMotion(Transition.C01101 r3) {
