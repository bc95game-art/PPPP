...
public final class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    public final C00181 mHideListener = new C00181(this, 0);
    public final C00181 mShowListener = new C00181(this, 1);
    public final FakeDrag mUpdateListener = new FakeDrag(2, this);

    /* renamed from: androidx.appcompat.app.WindowDecorActionBar$1 */
    /* loaded from: classes.dex */
    public final class C00181 extends BundleKt {
        public final /* synthetic */ int $r8$classId;
        public final /* synthetic */ WindowDecorActionBar this$0;

        public /* synthetic */ C00181(WindowDecorActionBar windowDecorActionBar, int i) {
            this.$r8$classId = i;
    ...
    public final void animateToMode(boolean z) {
        ...
        if (this.mContainerView.isLaidOut()) {
            if (z) {
                ...
                viewPropertyAnimatorCompat2.setListener(new ToolbarWidgetWrapper.C00412(toolbarWidgetWrapper, 4));
                ...
                animate.setListener(new ToolbarWidgetWrapper.C00412(toolbarWidgetWrapper2, 0));
    ...
    public final Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0130R.attr.actionBarWidgetTheme, typedValue, true);
    ...
    public final void init(View view) {
        ...
        boolean z;
        String str;
        ActionBarOverlayLayout actionBarOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0130R.C0132id.decor_content_parent);
        this.mOverlayLayout = actionBarOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        View findViewById = view.findViewById(C0130R.C0132id.action_bar);
        ...
        this.mContextView = (ActionBarContextView) view.findViewById(C0130R.C0132id.action_context_bar);
        ActionBarContainer actionBarContainer = (ActionBarContainer) view.findViewById(C0130R.C0132id.action_bar_container);
        ...
        setHasEmbeddedTabs(context.getResources().getBoolean(C0130R.bool.abc_action_bar_embed_tabs));
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(null, R$styleable.ActionBar, C0130R.attr.actionBarStyle, 0);
    ...
    public final void onConfigurationChanged() {
        setHasEmbeddedTabs(this.mContext.getResources().getBoolean(C0130R.bool.abc_action_bar_embed_tabs));
    }
