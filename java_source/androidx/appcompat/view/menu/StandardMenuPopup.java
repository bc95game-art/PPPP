...
public final class StandardMenuPopup extends MenuPopup implements PopupWindow.OnDismissListener, View.OnKeyListener {
    ...
    public final AppCompatSpinner.ViewTreeObserver$OnGlobalLayoutListenerC00252 mGlobalLayoutListener = new AppCompatSpinner.ViewTreeObserver$OnGlobalLayoutListenerC00252(2, this);
    public final View$OnAttachStateChangeListenerC00202 mAttachStateChangeListener = new View$OnAttachStateChangeListenerC00202(0, this);
    ...
    public StandardMenuPopup(Context context, MenuBuilder menuBuilder, View view, int i, boolean z) {
        ...
        this.mAdapter = new MenuAdapter(menuBuilder, LayoutInflater.from(context), z, C0130R.layout.abc_popup_menu_item_layout);
        this.mPopupStyleAttr = i;
        Resources resources = context.getResources();
        this.mPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0130R.dimen.abc_config_prefDialogWidth));
        ...
        if (!isShowing()) {
            ...
            if (this.mShowTitle) {
                ...
                if (menuBuilder.mHeaderTitle != null) {
                    FrameLayout frameLayout = (FrameLayout) LayoutInflater.from(context).inflate(C0130R.layout.abc_popup_menu_header_item_layout, (ViewGroup) dropDownListView, false);
    ...
    /* loaded from: classes.dex */
    public final class View$OnAttachStateChangeListenerC00202 implements View.OnAttachStateChangeListener {
        public final /* synthetic */ int $r8$classId;
        public final /* synthetic */ Object this$0;

        public /* synthetic */ View$OnAttachStateChangeListenerC00202(int i, Object obj) {
            this.$r8$classId = i;
            this.this$0 = obj;
        }
        ...
        /* renamed from: onViewAttachedToWindow$androidx$appcompat$view$menu$CascadingMenuPopup$2 */
        private final void m627x2422cadb(View view) {
        }

        /* renamed from: onViewAttachedToWindow$androidx$appcompat$view$menu$StandardMenuPopup$2 */
        private final void m626x83cdb48d(View view) {
        }

        /* renamed from: onViewAttachedToWindow$com$google$android$material$behavior$HideBottomViewOnScrollBehavior$1 */
        private final void m625xe499fc9e(View view) {
        }

        /* renamed from: onViewAttachedToWindow$com$google$android$material$behavior$HideViewOnScrollBehavior$1 */
        private final void m624xb84076d3(View view) {
        }
    }
}
