...
public class ActionMenuItemView extends AppCompatTextView implements MenuView.ItemView, View.OnClickListener, ActionMenuView.ActionMenuChildView {
    ...
    public ActionMenuPresenter.OverflowMenuButton.C00221 mForwardingListener;
    ...
    public final void initialize(MenuItemImpl menuItemImpl) {
        ...
        if (menuItemImpl.hasSubMenu() && this.mForwardingListener == null) {
            this.mForwardingListener = new ActionMenuPresenter.OverflowMenuButton.C00221(this);
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ActionMenuPresenter.OverflowMenuButton.C00221 r0;
