...
public final class ActionMenuItem implements SupportMenuItem {
    ...
    public final MenuItem mo632setContentDescription(CharSequence charSequence) {
    ...
    public final MenuItem mo633setTooltipText(CharSequence charSequence) {
    ...
    public final SupportMenuItem mo632setContentDescription(CharSequence charSequence) {
        this.mContentDescription = charSequence;
        return this;
    }
    ...
    public final SupportMenuItem mo633setTooltipText(CharSequence charSequence) {
        this.mTooltipText = charSequence;
        return this;
    }
