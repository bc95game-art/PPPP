...
public class AppCompatSpinner extends Spinner {
    ...
    public final C00241 mForwardingListener;
    ...
    /* loaded from: classes.dex */
    public final class ViewTreeObserver$OnGlobalLayoutListenerC00252 implements ViewTreeObserver.OnGlobalLayoutListener {
        public final /* synthetic */ int $r8$classId;
        public final /* synthetic */ Object this$0;

        public /* synthetic */ ViewTreeObserver$OnGlobalLayoutListenerC00252(int i, Object obj) {
            this.$r8$classId = i;
            this.this$0 = obj;
        }
    ...
    public final class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public DropdownPopup(Context context, AttributeSet attributeSet) {
            super(context, attributeSet, C0130R.attr.spinnerStyle, 0);
            this.mDropDownAnchorView = AppCompatSpinner.this;
            this.mModal = true;
            this.mPopup.setFocusable(true);
            this.mItemClickListener = new SearchView.C00358(1, this);
        }
        ...
        public final void show(int i, int i2) {
            ...
            if (!isShowing && (viewTreeObserver = appCompatSpinner.getViewTreeObserver()) != null) {
                final ViewTreeObserver$OnGlobalLayoutListenerC00252 r7 = new ViewTreeObserver$OnGlobalLayoutListenerC00252(3, this);
    ...
    */
    public AppCompatSpinner(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, C0130R.attr.spinnerStyle);
        Throwable th;
        Exception e;
        TypedArray typedArray;
        ThemeUtils.checkAppCompatTheme(getContext(), this);
        int[] iArr = R$styleable.Spinner;
        MatcherMatchResult obtainStyledAttributes = MatcherMatchResult.obtainStyledAttributes(context, attributeSet, iArr, C0130R.attr.spinnerStyle);
        TypedArray typedArray2 = (TypedArray) obtainStyledAttributes.input;
        ...
        try {
            typedArray = context.obtainStyledAttributes(attributeSet, ATTRS_ANDROID_SPINNERMODE, C0130R.attr.spinnerStyle, 0);
            try {
                try {
        ...
        if (i == 0) {
            ...
            MatcherMatchResult obtainStyledAttributes2 = MatcherMatchResult.obtainStyledAttributes(this.mPopupContext, attributeSet, iArr, C0130R.attr.spinnerStyle);
            this.mDropDownWidth = ((TypedArray) obtainStyledAttributes2.input).getLayoutDimension(3, -2);
        ...
        if (textArray != null) {
            ...
            arrayAdapter.setDropDownViewResource(C0130R.layout.support_simple_spinner_dropdown_item);
        ...
        this.mBackgroundTintHelper.loadFromAttributes(attributeSet, C0130R.attr.spinnerStyle);
    }
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (savedState.mShowDropdown && (viewTreeObserver = getViewTreeObserver()) != null) {
            viewTreeObserver.addOnGlobalLayoutListener(new ViewTreeObserver$OnGlobalLayoutListenerC00252(0, this));
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        C00241 r0 = this.mForwardingListener;
