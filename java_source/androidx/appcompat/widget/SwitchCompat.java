...
public class SwitchCompat extends CompoundButton {
    ...
    public static final ViewUtils.C01151 THUMB_POS = new ViewUtils.C01151(Float.class, "thumbPos", 1);
    ...
    */
    ...
    public void setChecked(boolean z) {
        ...
        if (isChecked) {
            if (Build.VERSION.SDK_INT >= 30) {
                ...
                if (obj == null) {
                    obj = getResources().getString(C0130R.string.abc_capital_on);
                }
                Object obj2 = obj;
                WeakHashMap weakHashMap = ViewCompat.sViewPropertyAnimatorMap;
                new ViewCompat.C00461(C0130R.C0132id.tag_state_description, CharSequence.class, 64, 30, 2).set(this, obj2);
            }
        } else if (Build.VERSION.SDK_INT >= 30) {
            Object obj3 = this.mTextOff;
            if (obj3 == null) {
                obj3 = getResources().getString(C0130R.string.abc_capital_off);
            }
            Object obj4 = obj3;
            WeakHashMap weakHashMap2 = ViewCompat.sViewPropertyAnimatorMap;
            new ViewCompat.C00461(C0130R.C0132id.tag_state_description, CharSequence.class, 64, 30, 2).set(this, obj4);
        }
        float f = 0.0f;
    ...
    public void setTextOff(CharSequence charSequence) {
        ...
        if (!isChecked() && Build.VERSION.SDK_INT >= 30) {
            ...
            if (obj == null) {
                obj = getResources().getString(C0130R.string.abc_capital_off);
            }
            WeakHashMap weakHashMap = ViewCompat.sViewPropertyAnimatorMap;
            new ViewCompat.C00461(C0130R.C0132id.tag_state_description, CharSequence.class, 64, 30, 2).set(this, obj);
        }
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, C0130R.attr.switchStyle);
        Typeface typeface;
        Typeface typeface2;
        int resourceId;
        ...
        MatcherMatchResult obtainStyledAttributes = MatcherMatchResult.obtainStyledAttributes(context, attributeSet, iArr, C0130R.attr.switchStyle);
        TypedArray typedArray = (TypedArray) obtainStyledAttributes.input;
        ViewCompat.saveAttributeDataForStyleable(this, context, iArr, attributeSet, typedArray, C0130R.attr.switchStyle);
        ...
        new AppCompatTextHelper(this).loadFromAttributes(attributeSet, C0130R.attr.switchStyle);
        obtainStyledAttributes.recycle();
        ViewConfiguration viewConfiguration = ViewConfiguration.get(context);
        this.mTouchSlop = viewConfiguration.getScaledTouchSlop();
        this.mMinFlingVelocity = viewConfiguration.getScaledMinimumFlingVelocity();
        getEmojiTextViewHelper().loadFromAttributes(attributeSet, C0130R.attr.switchStyle);
