...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public final RunnableC00281 mReleaseCursorRunnable;
    ...
    public final RunnableC00281 mUpdateDrawableStateRunnable;
    ...
    /* loaded from: classes.dex */
    public final class View$OnLayoutChangeListenerC00314 implements View.OnLayoutChangeListener {
        public final /* synthetic */ int $r8$classId;
        public final /* synthetic */ Object this$0;

        public /* synthetic */ View$OnLayoutChangeListenerC00314(int i, Object obj) {
            this.$r8$classId = i;
            this.this$0 = obj;
        }
                ...
                case 0:
                    ...
                    if (view2.getWidth() > 1) {
                        ...
                        if (searchView.mIconifiedByDefault) {
                            i11 = resources.getDimensionPixelSize(C0130R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0130R.dimen.abc_dropdownitem_text_padding_left);
                        }
    ...
    /* loaded from: classes.dex */
    public final class C00358 implements AdapterView.OnItemClickListener {
        public final /* synthetic */ int $r8$classId;
        public final /* synthetic */ Object this$0;

        public /* synthetic */ C00358(int i, Object obj) {
            this.$r8$classId = i;
            this.this$0 = obj;
        }
    ...
    public final class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new AbsSavedState.C00522(1);
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public final RunnableC00371 mRunShowSoftInputIfNecessary = new Runnable() { // from class: androidx.appcompat.widget.SearchView.SearchAutoComplete.1
        ...
        public final InputConnection onCreateInputConnection(EditorInfo editorInfo) {
            ...
            if (this.mHasPendingShowSoftInputRequest) {
                RunnableC00371 r0 = this.mRunShowSoftInputIfNecessary;
                removeCallbacks(r0);
                post(r0);
            }
        ...
        public void setImeVisibility(boolean z) {
            ...
            RunnableC00371 r1 = this.mRunShowSoftInputIfNecessary;
            if (!z) {
    ...
    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0130R.dimen.abc_search_view_preferred_height);
    }

    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0130R.dimen.abc_search_view_preferred_width);
    }
    ...
    */
    public void setSearchableInfo(SearchableInfo searchableInfo) {
        ...
        if (searchableInfo != null) {
            ...
            if (this.mSearchable.getSuggestAuthority() != null) {
                ...
                suggestionsAdapter2.mQueryRefinement = i;
            }
            updateQueryHint();
        }
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, C0130R.attr.searchViewStyle);
        ...
        C00358 r10 = new C00358(0, this);
        C00369 r11 = new C00369(0, this);
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr, C0130R.attr.searchViewStyle, 0);
        MatcherMatchResult matcherMatchResult = new MatcherMatchResult(context, obtainStyledAttributes);
        ViewCompat.saveAttributeDataForStyleable(this, context, iArr, attributeSet, obtainStyledAttributes, C0130R.attr.searchViewStyle);
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(19, C0130R.layout.abc_search_view), (ViewGroup) this, true);
        SearchAutoComplete searchAutoComplete = (SearchAutoComplete) findViewById(C0130R.C0132id.search_src_text);
        this.mSearchSrcTextView = searchAutoComplete;
        searchAutoComplete.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0130R.C0132id.search_edit_frame);
        View findViewById = findViewById(C0130R.C0132id.search_plate);
        this.mSearchPlate = findViewById;
        View findViewById2 = findViewById(C0130R.C0132id.submit_area);
        this.mSubmitArea = findViewById2;
        ImageView imageView = (ImageView) findViewById(C0130R.C0132id.search_button);
        this.mSearchButton = imageView;
        ImageView imageView2 = (ImageView) findViewById(C0130R.C0132id.search_go_btn);
        this.mGoButton = imageView2;
        ImageView imageView3 = (ImageView) findViewById(C0130R.C0132id.search_close_btn);
        this.mCloseButton = imageView3;
        ImageView imageView4 = (ImageView) findViewById(C0130R.C0132id.search_voice_btn);
        this.mVoiceButton = imageView4;
        ImageView imageView5 = (ImageView) findViewById(C0130R.C0132id.search_mag_icon);
        ...
        BundleKt.setTooltipText(imageView, getResources().getString(C0130R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(26, C0130R.layout.abc_search_dropdown_item_icons_2line);
        ...
        if (findViewById3 != null) {
            findViewById3.addOnLayoutChangeListener(new View$OnLayoutChangeListenerC00314(0, this));
        }
    ...
    /* loaded from: classes.dex */
    public final class C00369 implements AdapterView.OnItemSelectedListener {
        public final /* synthetic */ int $r8$classId;
        public final /* synthetic */ Object this$0;

        public /* synthetic */ C00369(int i, Object obj) {
            this.$r8$classId = i;
            this.this$0 = obj;
        }
