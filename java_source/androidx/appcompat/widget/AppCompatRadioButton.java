...
public class AppCompatRadioButton extends RadioButton implements TintableCompoundButton, TintableCompoundDrawablesView {
    ...
    public AppCompatRadioButton(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, C0130R.attr.radioButtonStyle);
        ...
        appCompatCompoundButtonHelper.loadFromAttributes(attributeSet, C0130R.attr.radioButtonStyle);
        NavDestinationImpl navDestinationImpl = new NavDestinationImpl(this);
        this.mBackgroundTintHelper = navDestinationImpl;
        navDestinationImpl.loadFromAttributes(attributeSet, C0130R.attr.radioButtonStyle);
        AppCompatTextHelper appCompatTextHelper = new AppCompatTextHelper(this);
        this.mTextHelper = appCompatTextHelper;
        appCompatTextHelper.loadFromAttributes(attributeSet, C0130R.attr.radioButtonStyle);
        getEmojiTextViewHelper().loadFromAttributes(attributeSet, C0130R.attr.radioButtonStyle);
    }
