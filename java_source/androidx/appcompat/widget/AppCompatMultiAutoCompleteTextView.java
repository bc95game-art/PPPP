...
public final class AppCompatMultiAutoCompleteTextView extends MultiAutoCompleteTextView implements TintableCompoundDrawablesView {
    ...
    public AppCompatMultiAutoCompleteTextView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, C0130R.attr.autoCompleteTextViewStyle);
        TintContextWrapper.wrap(context);
        ThemeUtils.checkAppCompatTheme(getContext(), this);
        MatcherMatchResult obtainStyledAttributes = MatcherMatchResult.obtainStyledAttributes(getContext(), attributeSet, TINT_ATTRS, C0130R.attr.autoCompleteTextViewStyle);
        ...
        navDestinationImpl.loadFromAttributes(attributeSet, C0130R.attr.autoCompleteTextViewStyle);
        AppCompatTextHelper appCompatTextHelper = new AppCompatTextHelper(this);
        this.mTextHelper = appCompatTextHelper;
        appCompatTextHelper.loadFromAttributes(attributeSet, C0130R.attr.autoCompleteTextViewStyle);
        ...
        appCompatProgressBarHelper.loadFromAttributes(attributeSet, C0130R.attr.autoCompleteTextViewStyle);
