...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent2, NestedScrollingParent3 {
    public static final int[] ATTRS = {C0130R.attr.actionBarSize, 16842841};
    ...
    public final Transition.C01123 mTopAnimatorListener = new Transition.C01123(1, this);
    public final RunnableC00212 mRemoveActionBarHideOffset = new RunnableC00212(this, 0);
    public final RunnableC00212 mAddActionBarHideOffset = new RunnableC00212(this, 1);
    public final NavOptions.Builder mParentHelper = new Object();

    /* renamed from: androidx.appcompat.widget.ActionBarOverlayLayout$2 */
    /* loaded from: classes.dex */
    public final class RunnableC00212 implements Runnable {
        public final /* synthetic */ int $r8$classId;
        public final /* synthetic */ ActionBarOverlayLayout this$0;

        public /* synthetic */ RunnableC00212(ActionBarOverlayLayout actionBarOverlayLayout, int i) {
            this.$r8$classId = i;
    ...
    static {
        ...
        builderImpl.setSystemWindowInsets(Insets.m620of(0, 1, 0, 1));
    ...
    */
    public final void onMeasure(int i, int i2) {
        ...
        if (!this.mOverlayMode && !z) {
            ...
            if (!rect3.equals(ZERO_INSETS)) {
                ...
                this.mInnerInsets = this.mInnerInsets.mImpl.inset(0, i3, 0, 0);
        ...
        Insets of = Insets.m620of(this.mInnerInsets.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + i3, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom());
        WindowInsetsCompat windowInsetsCompat3 = this.mInnerInsets;
        int i4 = Build.VERSION.SDK_INT;
        if (i4 >= 30) {
            builderImpl = new WindowInsetsCompat.BuilderImpl30(windowInsetsCompat3);
        } else if (i4 >= 29) {
            builderImpl = new WindowInsetsCompat.BuilderImpl29(windowInsetsCompat3);
        } else {
            builderImpl = new WindowInsetsCompat.BuilderImpl20(windowInsetsCompat3);
        }
    ...
    public final void pullChildren() {
        ...
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0130R.C0132id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0130R.C0132id.action_bar_container);
            View findViewById = findViewById(C0130R.C0132id.action_bar);
    ...
    public final void setMenu(Menu menu, MenuPresenter.Callback callback) {
        ...
        if (toolbarWidgetWrapper.mActionMenuPresenter == null) {
            ...
            actionMenuPresenter.mId = C0130R.C0132id.action_menu_presenter;
        }
