    ...
    */
    public static boolean handleDeleteSurroundingText(EmojiInputConnection emojiInputConnection, Editable editable, int i, int i2, boolean z) {
        ...
        if (editable != null && i >= 0 && i2 >= 0) {
            ...
            if (!(selectionStart == -1 || selectionEnd == -1 || selectionStart != selectionEnd)) {
                ...
                TypefaceEmojiSpan[] typefaceEmojiSpanArr = (TypefaceEmojiSpan[]) editable.getSpans(selectionStart, i3, TypefaceEmojiSpan.class);
    ...
    public CharSequence provideSummary(Preference preference) {
        ...
        if (TextUtils.isEmpty(editTextPreference.mText)) {
            return editTextPreference.mContext.getString(C0130R.string.not_set);
        }
