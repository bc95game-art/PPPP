...
public final class ViewPager2 extends ViewGroup {
    ...
    public final C01211 mCurrentItemDataSetChangeObserver = new RecyclerView.AdapterDataObserver() { // from class: androidx.viewpager2.widget.ViewPager2.1
    ...
    /* loaded from: classes.dex */
    public final class C01234 implements RecyclerView.OnChildAttachStateChangeListener {
    }
    ...
    public final class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new AbsSavedState.C00522(8);
    ...
    public void setAdapter(RecyclerView.Adapter adapter) {
        ...
        MetadataRepo metadataRepo = this.mAccessibilityProvider;
        if (adapter2 != null) {
            adapter2.unregisterAdapterDataObserver((C01211) metadataRepo.mRootNode);
        } else {
            metadataRepo.getClass();
        }
        C01211 r1 = this.mCurrentItemDataSetChangeObserver;
        if (adapter2 != null) {
        ...
        if (adapter != null) {
            adapter.registerAdapterDataObserver((C01211) metadataRepo2.mRootNode);
        }
        if (adapter != null) {
