...
import androidx.fragment.app.C0072x7c22a489;
...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter {
    ...
    public final class FragmentMaxLifecycleEnforcer {
        ...
        public C01203 mLifecycleObserver;
    ...
    public void placeFragmentInViewHolder(FragmentViewHolder fragmentViewHolder) {
        ...
        if (fragment != null) {
            ...
            if (!fragment.isAdded() && view != null) {
                ...
                ((CopyOnWriteArrayList) fragmentAnim$AnimationOrAnimator.animator).add(new C0072x7c22a489(matcherMatchResult));
                ...
                if (fragment.isAdded()) {
                    ...
                    ((CopyOnWriteArrayList) fragmentAnim$AnimationOrAnimator2.animator).add(new C0072x7c22a489(matcherMatchResult2));
