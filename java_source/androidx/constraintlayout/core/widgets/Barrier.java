...
public final class Barrier extends HelperWidget {
    ...
    public final void addToSolver(LinearSystem linearSystem, boolean z) {
        ...
        if (i6 >= 0 && i6 < 4) {
            ...
            if (this.mResolved) {
                ...
                if (i7 == 0 || i7 == 1) {
                    linearSystem.addEquality(constraintAnchor.mSolverVariable, this.f2mX);
                    linearSystem.addEquality(constraintAnchor3.mSolverVariable, this.f2mX);
                } else if (i7 == 2 || i7 == 3) {
                    linearSystem.addEquality(constraintAnchor2.mSolverVariable, this.f3mY);
                    linearSystem.addEquality(constraintAnchor4.mSolverVariable, this.f3mY);
                }
            } else {
    ...
    public final String toString() {
        String m = ViewModelProvider.Factory.CC.m593m(new StringBuilder("[Barrier] "), this.mDebugName, " {");
        ...
        return ViewModelProvider.Factory.CC.m596m(m, "}");
    }
}
