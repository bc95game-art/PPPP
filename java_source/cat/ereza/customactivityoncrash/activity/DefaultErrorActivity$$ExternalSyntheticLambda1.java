    ...
    public final void onClick(View view) {
        ...
        switch (i) {
            ...
            default:
                ...
                zzbvVar.setNeutralButton(C0130R.string.customactivityoncrash_error_activity_error_details_copy, new AppsFragment$$ExternalSyntheticLambda0(1, defaultErrorActivity));
                TextView textView = (TextView) zzbvVar.show().findViewById(16908299);
                if (textView != null) {
                    textView.setTextSize(0, defaultErrorActivity.getResources().getDimension(C0130R.dimen.customactivityoncrash_error_activity_error_details_text_size));
                    return;
                }
                return;
        }
