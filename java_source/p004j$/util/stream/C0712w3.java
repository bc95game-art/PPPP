...
public final class C0712w3 extends AbstractC0653q4 implements AbstractC0643p4, AbstractC0584j5 {

    /* renamed from: b */
    public final /* synthetic */ Supplier f804b;

    /* renamed from: c */
    public final /* synthetic */ ObjLongConsumer f805c;

    /* renamed from: d */
    public final /* synthetic */ C0618n f806d;
    ...
    public final void mo57i(AbstractC0643p4 p4Var) {
        this.f709a = this.f806d.apply(this.f709a, ((C0712w3) p4Var).f709a);
    }

    @Override // p004j$.util.stream.AbstractC0594k5
    /* renamed from: c */
    public final void mo23c(long j) {
        this.f709a = this.f804b.get();
    }

    @Override // p004j$.util.stream.AbstractC0594k5, java.util.function.LongConsumer
    public final void accept(long j) {
        this.f805c.accept(this.f709a, j);
    }

    public C0712w3(Supplier supplier, ObjLongConsumer objLongConsumer, C0618n nVar) {
        this.f804b = supplier;
        this.f805c = objLongConsumer;
        this.f806d = nVar;
    }
}
