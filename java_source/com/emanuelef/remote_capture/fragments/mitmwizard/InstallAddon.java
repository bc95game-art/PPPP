...
public class InstallAddon extends StepFragment {
    private void addonOk() {
        nextStep(C0130R.C0132id.navto_install_cert);
    }
    ...
    private void installAddon(String str) {
        ...
        if (installedVersionName.isEmpty()) {
            this.mStepLabel.setText(C0130R.string.install_the_mitm_addon);
            this.mStepButton.setText(C0130R.string.install_action);
        } else if (Utils.isSemanticVersionCompatible(installedVersionName, str)) {
            this.mStepLabel.setText(C0130R.string.mitm_addon_update_available);
            this.mStepButton.setText(C0130R.string.update_action);
            showSkipButton(new AppsFragment$$ExternalSyntheticLambda2(7, this));
        } else if (MitmAddon.getInstalledVersion(requireContext()) < 21) {
            this.mStepLabel.setText(C0130R.string.mitm_addon_new_version);
            this.mStepButton.setText(C0130R.string.update_action);
        } else {
            this.mStepLabel.setText(getString(C0130R.string.mitm_addon_bad_version, MitmAddon.PACKAGE_VERSION_NAME));
    ...
    public /* synthetic */ void lambda$installAddon$0(View view) {
        gotoStep(C0130R.C0132id.navto_install_cert);
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        Utils.setTextUrls(this.mStepLabel, C0130R.string.install_the_mitm_addon, MitmAddon.REPOSITORY);
