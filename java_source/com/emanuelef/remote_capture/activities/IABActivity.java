...
public class IABActivity extends BaseActivity implements PlayBilling.PurchaseReadyListener, SKUsAdapter.SKUClickListener {
    ...
    private void checkQrActivationRequest(Intent intent) {
        ...
        if (data != null && data.getHost().equals("get_license")) {
            if (!this.mIab.isAvailable(Billing.UNLOCK_TOKEN_SKU)) {
                Utils.showToast(this, C0130R.string.feature_not_available, new Object[0]);
                return;
            }
    ...
    public void onCreate(Bundle bundle) {
        ...
        setTitle(C0130R.string.paid_features);
        displayBackAction();
        ...
        textView.setText(C0130R.string.loading);
        this.mAdapter = new SKUsAdapter(this, this.mIab, this);
        ((ListView) findViewById(C0130R.C0132id.listview)).setAdapter((ListAdapter) this.mAdapter);
    ...
    public void onPurchasesError() {
        ...
        this.mListEmpty.setText(C0130R.string.billing_failure);
        reloadAvailableSkus();
    }
    ...
    public void onPurchasesReady() {
        ...
        this.mListEmpty.setText(C0130R.string.no_items_for_purchase);
        reloadAvailableSkus();
    ...
    public void onSKUStateUpdate(String str, int i) {
        StringBuilder m = ViewModelProvider.Factory.CC.m594m("SKU ", str, " state update: ");
