...
.method public final synthetic findAny()Ljava/util/Optional;
    ...
    invoke-interface {v0}, Lj$/util/stream/Stream;->findAny()Lj$/util/y;

    move-result-object v0

    invoke-static {v0}, Lj$/com/android/tools/r8/a;->H(Lj$/util/y;)Ljava/util/Optional;
...
.method public final synthetic findFirst()Ljava/util/Optional;
    ...
    invoke-interface {v0}, Lj$/util/stream/Stream;->findFirst()Lj$/util/y;
...
.method public final synthetic flatMap(Ljava/util/function/Function;)Ljava/util/stream/Stream;
    ...
    invoke-static {p1}, Lj$/util/stream/u3;->r0(Ljava/util/function/Function;)Lj$/util/n;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->d(Lj$/util/n;)Lj$/util/stream/Stream;
...
.method public final synthetic flatMapToDouble(Ljava/util/function/Function;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->z(Lj$/util/n;)Lj$/util/stream/b0;
...
.method public final synthetic flatMapToInt(Ljava/util/function/Function;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->o(Lj$/util/n;)Lj$/util/stream/IntStream;
...
.method public final synthetic flatMapToLong(Ljava/util/function/Function;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->m(Lj$/util/n;)Lj$/util/stream/k1;
...
.method public final synthetic max(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->max(Ljava/util/Comparator;)Lj$/util/y;

    move-result-object p1

    invoke-static {p1}, Lj$/com/android/tools/r8/a;->H(Lj$/util/y;)Ljava/util/Optional;
...
.method public final synthetic min(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->min(Ljava/util/Comparator;)Lj$/util/y;
...
.method public final synthetic reduce(Ljava/util/function/BinaryOperator;)Ljava/util/Optional;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->reduce(Ljava/util/function/BinaryOperator;)Lj$/util/y;
