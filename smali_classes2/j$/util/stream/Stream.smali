...
.method public abstract d(Lj$/util/n;)Lj$/util/stream/Stream;
.end method
...
.method public abstract findAny()Lj$/util/y;
.end method

.method public abstract findFirst()Lj$/util/y;
.end method
...
.method public abstract m(Lj$/util/n;)Lj$/util/stream/k1;
.end method
...
.method public abstract max(Ljava/util/Comparator;)Lj$/util/y;
.end method

.method public abstract min(Ljava/util/Comparator;)Lj$/util/y;
.end method

.method public abstract noneMatch(Ljava/util/function/Predicate;)Z
.end method

.method public abstract o(Lj$/util/n;)Lj$/util/stream/IntStream;
.end method

.method public abstract peek(Ljava/util/function/Consumer;)Lj$/util/stream/Stream;
.end method

.method public abstract reduce(Ljava/util/function/BinaryOperator;)Lj$/util/y;
.end method
...
.method public abstract z(Lj$/util/n;)Lj$/util/stream/b0;
.end method
